...
describe("FTM Dapp", function () {
    describe("QI Powah FTM", function () {
        ...
        it("Should setup required contract factories", async () => {
				...
				emptyAccountAddress = "0x6cc12f719081bc13d50029b6E18E7464B14d467c";

				accountAddressWithQi = "0x20dd72ed959b6147912c2e529f0a0c651c33c9ce";
				slotForQiOnAddressWithQI = 0;

				accountAddressWithRewardsStaking = "0xe32650e748e7e4aba16181d9882d15ba328d5a78";
				slotForAddressWithRewardsStaking = 0;

				accountAddressWithBeetsPool = "0x679016b3f8e98673f85c6f72567f22b58aa15a54";
				slotForAddressWithBeetsPool = 0;

				rewardsStakingAddress = "0x230917f8a262bF9f2C3959eC495b11D1B7E1aFfC";
				qiAddress = "0x68Aa691a8819B07988B18923F712F3f4C8d36346";
				beetsPoolAddress = "0x7aE6A223cde3A17E0B95626ef71A2DB5F03F540A";
        ...
        it("should deploy the contract and check an address with an empty balance without issue", async () =>{
				...
				it("should deploy the contract and check an address with reward staking", async () =>{
					...
					assert.equal(314338521461776300, txn, "address qi powah should be 314338521461776300")
				})
				...
				it("should deploy the contract and check an address with assets in the beets pool", async () =>{
					...
					assert.equal(77115560700627871254045, txn, "address qi powah should be 77115560700627871254045")
				})
